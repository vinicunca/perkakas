...
describe('regular (non-literal) size', () => {
  describe('mutable', () => {
    ...
    it('tuple with rest tail', () => {
      const result = chunk([123, 456] as [number, ...Array<number>], 2 as number);
    ...
    it('tuple with rest head', () => {
      const result = chunk([123, 456] as [...Array<number>, number], 2 as number);
...
describe('literal size', () => {
    ...
    describe('infinite tuples (rest/spread item)', () => {
      describe('prefix arrays', () => {
        ...
        it('prefix is same size as chunk size', () => {
          const result = chunk([1, 2] as [number, number, ...Array<boolean>], 2);
      ...
      describe('suffix arrays', () => {
        ...
        it('suffix is same size as chunk size', () => {
          const result = chunk([1, 2] as [...Array<boolean>, number, number], 2);
      ...
      it('both prefix and suffix', () => {
        const result = chunk([123, 'abc'] as [number, ...Array<boolean>, string], 2);
  ...
  it('above max', () => {
    const result = chunk(['abc', true] as [string, ...Array<number>, boolean], 1000);

    expectTypeOf(result).toEqualTypeOf<
      // These are simple non-empty arrays
      [
        [boolean | number | string, ...Array<boolean | number | string>],
        ...Array<[boolean | number | string, ...Array<boolean | number | string>]>,
      ]
    >();
  });
});
