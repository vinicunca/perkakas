...
describe('SplitByCase', () => {
  test('types', () => {
    expectTypeOf<SplitByCase<string>>().toEqualTypeOf<Array<string>>();
  });
...
describe('PascalCase', () => {
  test('types', () => {
    ...
    expectTypeOf<PascalCase<Array<string>, true>>().toEqualTypeOf<string>();
  });
...
describe('CamelCase', () => {
  test('types', () => {
    ...
    expectTypeOf<CamelCase<Array<string>, true>>().toEqualTypeOf<string>();
  });
...
describe('JoinByCase', () => {
  test('types', () => {
    ...
    expectTypeOf<JoinByCase<Array<string>, '-'>>().toEqualTypeOf<string>();
  });
