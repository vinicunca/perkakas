 ...
 * the data-last overload, and for utilities built on `curryFromLazy` (which
...
type SuffixPrefixes<
  Required extends Array<unknown>,
  Item,
  Suffix,
...
// we hoist the rest item's first iteration into a required slot...
  | [Item, ...Array<Item>, ...Prefixes<Suffix>]
