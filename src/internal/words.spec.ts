...
describe('unicode and special characters', () => {
  ...
  it('treats mixed scripts as single words', () => {
  ...
  it('treats emojis as part of words', () => {
    expect(words('hello🎉World')).toStrictEqual(['hello🎉World']);
  });

  it('treats special Unicode as part of words', () => {
    expect(words('data𝒽ello')).toStrictEqual(['data𝒽ello']);
  });

  it('preserves combining diacritical marks', () => {
