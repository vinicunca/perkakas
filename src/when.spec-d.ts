...
describe('dataFirst', () => {
  describe('no else', () => {
    describe('simple predicates', () => {
      it('mapper param is not narrowed', () => {
  ...
  describe('with else', () => {
    describe('simple predicates', () => {
      it('mapper\'s param is not narrowed', () => {
        const data = 'hello' as number | string;
...
describe('typing mismatches', () => {
  ...
  it('number of extra args enforced (data-first)', () => {
    when(
      1,
      constant(true),
  ...
  it('type of extra args enforced (data-last)', () => {
    map(
      [] as Array<string>,
      when(
        constant(true),
  ...
  it('number of extra args enforced (data-last)', () => {
    map(
      [] as Array<string>,
      when(
        constant(true),
