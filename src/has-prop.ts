...
type HasProp<T, Key extends PropertyKey> = T extends ReadonlyArray<unknown>
  ? never
...
export function hasProp(...args: ReadonlyArray<unknown>): unknown {
  return curry(hasPropImplementation, args);
}
