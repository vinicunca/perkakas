 ...
 * @example
 *  import { dropLastWhile } from '@vinicunca/perkakas';
 *
 ...
 * @example
 *  import { dropLastWhile, pipe } from '@vinicunca/perkakas';
 *
...
export function dropLastWhile(...args: Array<any>): unknown {
  return purry(dropLastWhile_, args);
}

function dropLastWhile_<T>(
  data: ReadonlyArray<T>,
  predicate: (item: T) => boolean,
): Array<T> {
