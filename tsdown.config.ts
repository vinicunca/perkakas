import type { RolldownChunk, UserConfig } from 'tsdown';
...
// enabling projects using to re-export Perkakas types.
...
async function injectAdditionalTypeDeclarations({
  ...
  readonly chunks: ReadonlyArray<RolldownChunk>;
}): Promise<void> {
